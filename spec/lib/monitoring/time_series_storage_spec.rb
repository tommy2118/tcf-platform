...
RSpec.describe TcfPlatform::Monitoring::TimeSeriesStorage do
  ...
  describe '#initialize' do
    ...
    it 'supports custom Redis configuration' do
      ...
      described_class.new(redis_config: custom_config)
  ...
  describe '#store_metric' do
    ...
    it 'stores metric data with timestamp-based key' do
      ...
      expect(redis_client).to have_received(:setex)
        .with(expected_key, 2_592_000, expected_data) # 30 days TTL
    end
  ...
  describe '#query_metrics' do
    ...
    it 'retrieves time-series data for specified time range' do
      index_key = 'metrics:index:gateway:cpu_percent'
      expected_timestamps = [1_693_276_800, 1_693_277_100, 1_693_277_400]
      ...
      allow(redis_client).to receive(:mget).and_return([
                                                         { value: 45.2, timestamp: 1_693_276_800 }.to_json,
                                                         { value: 47.8, timestamp: 1_693_277_100 }.to_json,
                                                         { value: 52.1, timestamp: 1_693_277_400 }.to_json
                                                       ])
      ...
      aggregate_failures do
        ...
        expect(result.first[:timestamp]).to eq(1_693_276_800)
      end
    end
  ...
  describe '#aggregate_metrics' do
    let(:raw_data) do
      [
        ...
        { value: 47.8, timestamp: 1_693_276_860 },
        { value: 52.1, timestamp: 1_693_276_920 },
        { value: 49.5, timestamp: 1_693_276_980 }
      ]
    end
